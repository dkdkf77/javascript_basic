...
(function(w) {
    ...
    try {
        var links = ["https:\/\/s.ad.smaato.net\/c\/?dspInit=1001376\u0026dspCookie=80063dbe9ecd5b7f295b05bb5fd8de96","https:\/\/sync.taboola.com\/sg\/widerplanetkorea-network\/1\/rtb-h\/?taboola_hm=80063dbe9ecd5b7f295b05bb5fd8de96","https:\/\/sbm.nate.com\/setCookie?venderKey=wider\u0026userKey=80063dbe9ecd5b7f295b05bb5fd8de96"],
            len = links.length,
            i;
        for (i=0; i<len; i++) {
            doPair(links[i]);
...
(function(w) {
    try {
        ...
        if (wp_uid) {
            ...
            if (is_wp_uid) {
                identity.setCookie('_wp_uid', "2-80063dbe9ecd5b7f295b05bb5fd8de96-s1658032248.402772|windows_10|chrome-1nkjp4c", 365);
                return;
            }
        }
